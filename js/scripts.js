...
function getLawyer() {
  ...
  function searchLawyer() {
    //julie
    if (
      selectedField == "Family Law" ||
      selectedField == "Divorce and Separation Law" ||
      selectedField == "Children Law"
    ) {
      document.getElementById("julieReturned").style.display = "block";
    }
    // john
    if (
      selectedField == "Banking and Finance" ||
      selectedField == "Criminal Law" ||
      selectedField == "Media and Entertainment Law" ||
      selectedField == "Personal Injury"
    ) {
      document.getElementById("johnReturned").style.display = "block";
    }
    //sherline
    if (
      selectedField == "Energy and Resources Law" ||
      selectedField == "Divorce and Separation Law" ||
      selectedField == "Intellectual Property Law" ||
      selectedField == "Administrative Law"
    ) {
      document.getElementById("sherlineReturned").style.display = "block";
    }
    //mark
    if (
      selectedField == "Business Law" ||
      selectedField == "Domestic Violence Law" ||
      selectedField == "Medical Law" ||
      selectedField == "Banking and Finance"
    ) {
    ...
    //justus
    if (
      selectedField == "Employment Law" ||
      selectedField == "Energy and Resources Law" ||
      selectedField == "Insurance Law" ||
      selectedField == "Administrative Law"
    ) {
    ...
    //fatuma
    if (
      selectedField == "Education Law" ||
      selectedField == "Domestic Violence" ||
      selectedField == "Intellectual Law"
    ) {
...
function contact() {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      Swal.fire(
        "Your notification has been sent! You will be notified on your inbox",
        "",
        "success"
      );
